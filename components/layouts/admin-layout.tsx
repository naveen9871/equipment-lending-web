...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    ...
    },
    {
      ...
      icon: Package,
      current: pathname.startsWith("/admin/equipment"),
      badge: null
    },
    {
      name: "Users",
    ...
    },
    {
      ...
      icon: Settings,
      current: pathname.startsWith("/admin/maintenance"),
      badge: "3"
    },
    {
      name: "Calendar",
      href: "/admin/calendar",
      icon: Calendar,
      current: pathname.startsWith("/admin/calendar"),
      badge: null
    }
  ]
  ...
  const notifications = [
    { 
      id: 1, 
      title: "New Request", 
      message: "Student requested camera equipment", 
      time: "2 min ago", 
      read: false,
      type: "info"
    },
    { 
      ...
      message: "Tripods running low (2 remaining)", 
      time: "1 hour ago", 
      read: true,
      type: "warning"
    },
    { 
      ...
      message: "3 items overdue for return", 
      time: "3 hours ago", 
      read: true,
      type: "error"
    },
    { 
      ...
      message: "Microscope needs calibration", 
      time: "5 hours ago", 
      read: true,
      type: "warning"
    }
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-100/30">
      ...
      >
        <div className="flex flex-col h-full">
                ...
                >
                  <div className={`p-2 rounded-xl transition-all duration-200 ${
                    ...
                    <Icon className={`w-4 h-4 ${
                      item.current ? "text-white" : "text-gray-600 group-hover:text-purple-600"
                    }`} />
                  </div>
                  {sidebarOpen && (
                    <>
          ...
          <div className="p-6 border-t border-white/60">
            <div className={`flex items-center gap-3 p-3 rounded-2xl bg-gradient-to-r from-purple-50 to-indigo-50 backdrop-blur-sm border border-purple-200/60 ${
              sidebarOpen ? "justify-between" : "justify-center"
            }`}>
              {sidebarOpen ? (
                <>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-gradient-to-br from-purple-600 to-indigo-700 rounded-full flex items-center justify-center text-white text-sm font-bold">
                      A
                    </div>
                    <div className="flex flex-col">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-500">
                  <Link href="/admin/dashboard" className="hover:text-purple-600 transition-colors">
                    Admin
                  </Link>
                  <ChevronRight className="w-4 h-4" />
                  <span className="text-gray-900 font-medium">
                    {pathname === "/admin/dashboard" && "Dashboard"}
                    {pathname.startsWith("/admin/requests") && "Requests"}
                    {pathname.startsWith("/admin/equipment") && "Equipment"}
                    {pathname.startsWith("/admin/users") && "Users"}
                    {pathname.startsWith("/admin/maintenance") && "Maintenance"}
                    {pathname.startsWith("/admin/calendar") && "Calendar"}
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder="Search..."
                    className="pl-10 pr-4 py-2 rounded-2xl border border-gray-200 bg-white/50 focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all duration-200 w-64"
                  />
                </div>
                ...
                <div className="relative">
                  ...
                  {notificationsOpen && (
                    <>
                      ...
                      />
                      <div className="absolute right-0 top-12 w-96 bg-white/90 backdrop-blur-xl rounded-2xl border border-white/60 shadow-2xl z-50 py-2">
                        <div className="px-4 py-3 border-b border-white/60 flex justify-between items-center">
                        ...
                        <div className="px-4 py-2 border-t border-white/60">
                          <button className="text-sm text-purple-600 hover:text-purple-700 font-medium w-full text-center py-2">
                  ...
                  {userMenuOpen && (
                    <>
                      ...
                      <div className="absolute right-0 top-12 w-56 bg-white/90 backdrop-blur-xl rounded-2xl border border-white/60 shadow-2xl z-50 py-2">
                        ...
                        <div className="py-2">
                          <button className="flex items-center gap-3 w-full px-4 py-2 text-sm text-gray-700 hover:bg-white/60 transition-colors rounded-lg">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-40 -right-32 w-80 h-80 bg-gradient-to-r from-purple-200 to-indigo-200 rounded-full blur-3xl opacity-20 animate-pulse"></div>
        <div className="absolute -bottom-40 -left-32 w-80 h-80 bg-gradient-to-r from-blue-200 to-cyan-200 rounded-full blur-3xl opacity-20 animate-pulse delay-1000"></div>
      </div>
    </div>
  )
}